...
if __name__ == "__main__":
    ...
    frame_number_to_visulize = 2
    # path of the folder:
    dataset_main_path = 'datasets/test_dataset'
    ...
    ############ generate the linemode dataset #############
    make_linemode_dataset(dataset_main_path+'/NDDS_generated', dataset_main_path, model_number, length_multipler)
    ############ generate the linemode dataset #############
